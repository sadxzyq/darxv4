...
let handler = async (m, { conn, generateWAMessageFromContent, }) => {
    ...
    const fgclink = {
           ...
           "message": {
               "groupInviteMessage": {
                   "groupJid": "6282285357346-1625305606@g.us",
                   "inviteCode": "null",
                   "groupName": "Halo", 
                   "caption": wm, 
...
conn.sendButtonDoc(m.chat, '▷ʙᴏᴛ sᴛᴀᴛᴜs◁', sts, 'Owner', '.owner', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https//wa.me/6282285357346?text=Hᴀʟᴏ+ɢᴀɴᴛᴇɴɢᴋᴜ',
    mediaType: 2, 
    description: 'wa.me/6282285357346?text=Hᴀʟᴏ+ɢᴀɴᴛᴇɴɢᴋᴜ',
    title: "Iɴɪ Fᴀᴄᴇʙᴏᴏᴋ Gᴡ!",
    body: wm,
    thumbnail: fs.readFileSync('./thumbnail.jpg'),
    sourceUrl: 'https://facebook.com/An Ak Hi Lang'
     }}
  })
