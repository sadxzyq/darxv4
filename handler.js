...
if (!isNumber(user.ayam)) user.ayam = 0
        ...
        if (!isNumber(user.intelligence))
              user.intelligence = 0
                ...
                global.db.data.users[m.sender] = {
                    exp: 1111111111111111111111111111111111111111111111111111111111,
                    limit: 111111111111111111111111,
                    lastclaim: 0,
                    registered: false,
                    spammer: 0,
                    antispam: 0,
                    ...
                    money: 11111111111111111111111111111111111111111111111,
                    bank: 0,
                    atm: 0,
                    fullatm: 0,
                    health: 100,
...
esteh: 0,
    ...
    return new Promise(async(resolve, reject) => {
        ...
        resolve(ab)
          ...
          global.kontak2 = [
        ['6282285357346', 'Darkx-𝘽𝙤𝙩𝙯', 'Creator Bot', 'Creator Bot', true],
...
*.delete*`, author, [['OFF FITURE', '.off antidelete'],['「𝕄𝔼ℕ𝕌」', '.menu']], msg, adReply)
...
Fitur ini di *disable* !`
    ...
    if (msg) return conn.sendButton(m.chat, danied, msg, `${imgr + 'Accses Danied'}`, [['「𝕄𝔼ℕ𝕌」', '.menu'],['「𝕆𝕎ℕ𝔼ℝ」', '.menu']],m)
...
if (msgg) return conn.sendButton(m.chat, `${global.htki} 「𝙻𝙾𝙶-𝙸𝙽」  ${global.htka}`, msgg, `${imgr + 'Verify'}`, [['「𝙻𝙾𝙶-𝙸𝙽」', '/verify']],m)
}    
